...
My work covers both halves of the problem: designing and optimizing the models — CNNs, Transformers, and ensembles, including quantization and pruning to cut inference latency by 30% — and building the data infrastructure they run on, from Kafka ELT pipelines feeding Snowflake to ETL processing 500GB+ of unstructured data.
